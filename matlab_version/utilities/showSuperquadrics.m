function [] = showSuperquadrics(x,varargin)
...
%         
%             beta=atan2(y_temp,x_temp);
%             r=cos(x(13)-beta)*z_norm;
%         
%         %   gamma=point_gen(:,3)./x(12);
%             gamma=point_temp(3)*x(12);
%             
%             % Radius not conflict to rotation R
%             Radius=1/x(12)-cos(gamma)*(1/x(12)-r);
%         
%         
%             point_temp(1) = x_temp+cos(x(13))*(Radius-r);
%             point_temp(2) = y_temp+sin(x(13))*(Radius-r);
%             point_temp(3) = sin(gamma)*(1/x(12)-r);
%         
%         end
